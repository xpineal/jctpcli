...
class InstrumentTest {
    ...
    void onOrderTradeBuy1() {
        var orderInfo = new OrderInfo("1", 1, 100, instrument.instrumentID, Direction.OpenBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 120, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeBuy2() {
        var orderInfo = new OrderInfo("1", 2, 100, instrument.instrumentID, Direction.OpenBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 120, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
    ...
    void onOrderTradeBuy3() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 2, 120, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeBuy4() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 80, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeBuy5() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 60, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeBuy6() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 2, 60, instrument.instrumentID, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeSell1() {
        var orderInfo = new OrderInfo("1", 1, 100, instrument.instrumentID, Direction.OpenSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 120, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeSell2() {
        var orderInfo = new OrderInfo("1", 2, 100, instrument.instrumentID, Direction.OpenSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 120, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
    ...
    void onOrderTradeSell3() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 2, 120, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeSell4() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 80, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeSell5() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 1, 60, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
    ...
    void onOrderTradeSell6() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
        orderInfo = new OrderInfo("2", 2, 60, instrument.instrumentID, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument);
    }
