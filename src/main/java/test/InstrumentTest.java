...
class InstrumentTest {
    ...
    void onOrderTradeBuy1() {
        var orderInfo = new OrderInfo("1", 1, 100, Direction.OpenBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 120, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeBuy2() {
        var orderInfo = new OrderInfo("1", 2, 100, Direction.OpenBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 120, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
    ...
    void onOrderTradeBuy3() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 2, 120, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeBuy4() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 80, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeBuy5() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 60, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeBuy6() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 2, 60, Direction.CloseBuy);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeSell1() {
        var orderInfo = new OrderInfo("1", 1, 100, Direction.OpenSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 120, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeSell2() {
        var orderInfo = new OrderInfo("1", 2, 100, Direction.OpenSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 120, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
    ...
    void onOrderTradeSell3() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 2, 120, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeSell4() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 80, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeSell5() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 1, 60, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
    ...
    void onOrderTradeSell6() {
        ...
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
        orderInfo = new OrderInfo("2", 2, 60, Direction.CloseSell);
        instrument.OnOrderTrade(orderInfo);
        System.out.println(instrument.holdInfo());
    }
